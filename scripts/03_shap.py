...
# plotly_template_with_korean() 의 title.font 와 우리가 넘기는 title 텍스트가
# 충돌하지 않도록 layout dict 에서 머지.
_korean_layout = plotly_template_with_korean()
...
fig_top.update_layout(
    ...
    height=520,
    **{**_korean_layout, "title": {"text": "상위 20 SHAP 기여 센서", **_korean_layout.get("title", {})}},
)
...
fig_wf.update_layout(
    **{**_korean_layout, "title": {"text": f"Waterfall — 샘플 {first_sid} (base={waterfall_demo['base_value']:.3f})", **_korean_layout.get("title", {})}},
)
