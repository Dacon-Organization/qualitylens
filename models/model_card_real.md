...
- 데이터 소스: **REAL** (UCI SECOM 실데이터 / 더미 합성)
...
## 성능
- CV  MCC  : 0.9727 ± 0.0074
- CV  PRAUC: 0.9993 ± 0.0006
- Test MCC (@0.5)             : 0.1388
- Test MCC (@0.0311, Youden's J): 0.2629
- Test PR-AUC                 : 0.1813
...
## 산출물
- `models/xgb_secom_real.joblib`     — 직렬화 모델
- `models/threshold_table_real.csv`  — sensor별 mean±2σ 정상 범위
